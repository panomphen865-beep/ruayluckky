...
export default function Page() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-b from-zinc-950 via-black to-zinc-900">
      <section className="grain relative mx-auto flex min-h-screen w-full max-w-6xl flex-col items-center justify-center px-6 py-16">
        ...
        <h1 className="glow text-center text-4xl font-extrabold leading-tight text-yellow-300 md:text-6xl">
          Ruay Luckky
        </h1>
        ...
        <div className="mt-10 grid w-full gap-4 md:grid-cols-3">
          {features.map((f) => (
            <article
              key={f.title}
              className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-5 shadow-soft backdrop-blur"
            >
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
          ...
          <a
            ...
            target="_blank"
            className="rounded-xl border border-zinc-700 px-5 py-3 text-sm font-bold text-zinc-100 transition hover:bg-zinc-800"
          >
            Open GitHub
          </a>
        </div>
