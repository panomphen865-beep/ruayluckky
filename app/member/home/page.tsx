...
หน้าเล่นของลูกค้า • เลือกเกม ฝากเงิน โปรโมชั่น กิจกรรม
</p>
</header>

<section className="rounded-2xl border border-red-700/40 bg-black/30 p-2 overflow-hidden">
<Image
src="/assets/ruayluckky/banner/slide-01.jpg"
alt="banner"
width={1200}
height={420}
...
<button className="rounded-xl bg-red-600 px-4 py-2 font-semibold">
ออกจากระบบ
</button>
</form>
</div>
